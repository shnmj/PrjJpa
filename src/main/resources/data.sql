...
-- 회원정보 추가 : identity (email:'sss@naver.com', 'password:'aaa')
---- 기존 회원가입&로그인 시 세션이 살아있어서 자동 로그인됨 
---- 자동 로그인 됨 : 로그아웃 : /logout
INSERT INTO USERSJPA(email, password) VALUES ('sss@naver.com', '$2a$10$RYel4AU0RVGPO.SROHYNje/v9WxWOhppfP/vQlUOWXy9ra7jHGGqy');